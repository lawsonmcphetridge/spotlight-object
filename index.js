...
export const printAddress = ({name, address: {number, street, city, country }}) => `${name} lives at ${number} ${street}, ${city}, ${country}`
...
export const printUserInfo = ({ username, name: {first, last}, info: {favorites: {food, color}, pet: {type, name}, address: {number, street, city, country}}  }) => {
  return `
    Username: ${username},
